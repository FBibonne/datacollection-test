...
public class MonitoringRepository {
   ...
   DataSource dataSource;
    ...
    public String vulnerabilite(String injection){
        var requeteInjection="select role from user where username='"+injection+"'";
        String retour=null;
        try(var statement=dataSource.getConnection().createStatement()){
            var result= statement.executeQuery(requeteInjection);
            result.next();
